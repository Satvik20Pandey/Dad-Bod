...
export function initMore(logoutCallback) {
  ...
  document.querySelectorAll("[data-open-sheet]").forEach((el) => {
    el.addEventListener("click", () => {
      haptic(HAPTIC.tap);
      openLayer(el.getAttribute("data-open-sheet"));
    });
  });
...
function openHelp() {
  openPolicyModal(
    ...
    `<p>We're here for you.</p>
     ...
     <h3>FAQ</h3>
     <p><strong>Is Dad Bod really free?</strong><br/>Yes. Every feature — tracking, workouts, recipes, progress — is free.</p>
     <p><strong>Do I need an account or API key?</strong><br/>No. A name and email create a local profile on your device. All nutrition services are built in.</p>
     <p><strong>Where is my data stored?</strong><br/>On your device only. Use More → Data → Export for backups.</p>
     <p><strong>Does it work offline?</strong><br/>Yes — logging, workouts, and the Indian food dataset are fully offline. Online search, barcodes, recipes, and nearby places need internet.</p>`
  );
}
...
function openPrivacyPolicy() {
  openPolicyModal(
    ...
    `<p><em>Last updated: August 2026</em></p>
     ...
     <h3>Data deletion</h3>
     <p>Clear the app's storage, or use More → Data. Uninstalling removes everything.</p>
...
function openTerms() {
  openPolicyModal(
    ...
    `<p><em>Last updated: August 2026</em></p>
     ...
     <p>Nutrition values and calculators are educational estimates from published equations and public databases. Always consult a healthcare professional before starting a diet or exercise program.</p>
     ...
     <h3>Liability</h3>
     <p>Dad Bod is provided "as is" without warranties. We are not liable for health outcomes or data loss — keep backups via Export.</p>
